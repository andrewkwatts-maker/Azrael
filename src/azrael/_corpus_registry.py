"""Mythology corpus definitions for Azrael. Registered with eyecore.corpus_registry on import."""
from eyecore import corpus_registry as _registry
...
# Register with the shared framework so any package can discover these
_registry.register("mythology", MYTHOLOGY_CORPUSES)
